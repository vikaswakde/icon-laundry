    ...
    <section className="relative h-full flex items-center overflow-hidden pt-[12rem] md:h-screen ">
      <div className="absolute inset-0 z-0">
        {/* <Image 
          ...
          priority
        /> */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#091271] to-[#020808] opacity-70"></div>
      </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:space-x-12">
            ...
            >
              <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight tracking-tight">
                Premium <span className="text-yellow-400">Laundry</span> &{" "}
                <span className="text-yellow-400">Dry Cleaning</span> Excellence
              </h1>
              ...
              <p className="text-xl mb-8">
                Experience the Icon Laundry difference
              </p>
              <motion.button
                className="bg-white text-[#091271] px-10 py-4 rounded-full text-xl font-semibold hover:bg-opacity-90 transition-colors shadow-lg"
